    ...
    public function get_perencana_data_perencana($param,$type='count')
    {
        if ($param=='pusat') {
            if ($type=='count') {   
                ...
                return array(
                'query'         => $this->db->table('vw_perencana_pusat')->select('"",name,email,gender,universitas, golongan, kementrian_name, unit_kerja,provinsi, jabatan, periode'),
                'column_order'  => array('','name','email','gender', 'golongan', 'kementrian_name', 'unit_kerja','provinsi', 'jabatan', 'periode'),
                'order'         => array('name' => 'asc'),
                'column_search' => array('name', 'gender', 'golongan','universitas', 'kementrian_name', 'unit_kerja', 'jabatan', 'periode','provinsi','email')
                );
            }
        }elseif ($param=='daerah') {
            if ($type=='count') {   
                ...
                return array(
                    'query'         => $this->db->table('vw_perencana_daerah')->select('"",name,email,gender,universitas, golongan, kementrian_name, unit_kerja,provinsi, jabatan, periode'),
                    'column_order'  => array('','name','email','gender', 'golongan', 'kementrian_name', 'unit_kerja','provinsi', 'jabatan', 'periode'),
                    'order'         => array('name' => 'asc'),
                    'column_search' => array('name', 'gender', 'golongan','universitas', 'kementrian_name', 'unit_kerja', 'jabatan', 'periode','provinsi','email')
                    );
            ...
            if ($type=='count') {   
                ...
                return array(
                    'query'         => $this->db->table('vw_perencana_gabungan')->select('"",name,email,gender,universitas, golongan, kementrian_name, unit_kerja,provinsi, jabatan, periode'),
                    'column_order'  => array('','name','email','gender', 'golongan', 'kementrian_name', 'unit_kerja','provinsi', 'jabatan', 'periode'),
                    'order'         => array('name' => 'asc'),
                    'column_search' => array('name', 'gender', 'golongan','universitas', 'kementrian_name', 'unit_kerja', 'jabatan', 'periode','provinsi','email')
                    );
    ...
    public function get_perencana_data_tim_penilai($param,$type='count')
    {
        if ($param=='pusat') {
            if ($type=='count') {   
                ...
                return array(
                'query'         => $this->db->table('vw_penilai_pusat')->select('"",name,email,gender,universitas, golongan, kementrian_name, unit_kerja,provinsi, jabatan, periode'),
                'column_order'  => array('','name','email','gender', 'golongan', 'kementrian_name', 'unit_kerja','provinsi', 'jabatan', 'periode'),
                'order'         => array('name' => 'asc'),
                'column_search' => array('name', 'gender', 'golongan','universitas', 'kementrian_name', 'unit_kerja', 'jabatan', 'periode','provinsi','email')
                );
            ...
            if ($type=='count') {   
                ...
                return array(
                    'query'         => $this->db->table('vw_penilai_daerah')->select('"",name,email,gender,universitas, golongan, kementrian_name, unit_kerja,provinsi, jabatan, periode'),
                    'column_order'  => array('','name','email','gender', 'golongan', 'kementrian_name', 'unit_kerja','provinsi', 'jabatan', 'periode'),
                    'order'         => array('name' => 'asc'),
                    'column_search' => array('name', 'gender', 'golongan','universitas', 'kementrian_name', 'unit_kerja', 'jabatan', 'periode','provinsi','email')
                    );
            ...
            if ($type=='count') {   
                ...
                return array(
                    'query'         => $this->db->table('vw_penilai_gabungan')->select('"",name,email,gender,universitas, golongan, kementrian_name, unit_kerja,provinsi, jabatan, periode'),
                    'column_order'  => array('','name','email','gender', 'golongan', 'kementrian_name', 'unit_kerja','provinsi', 'jabatan', 'periode'),
                    'order'         => array('name' => 'asc'),
                    'column_search' => array('name', 'gender', 'golongan','universitas', 'kementrian_name', 'unit_kerja', 'jabatan', 'periode','provinsi','email')
                    );
