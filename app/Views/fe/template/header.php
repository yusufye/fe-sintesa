...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="<?php echo base_url(); ?>" class="logo"><img src="<?php echo base_url();?>/public/assets/main/logo-sintesa-new-220x45.png" alt="Sintesa"></a>
      ...
      <a href="index.html" class="logo d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block d-lg-none d-xl-block"><img src="<?php echo base_url();?>/public/assets/main/logo_pusbin _bappenas _transparant.png" alt="pusbindiklatren"></a>
    </div>
  </header><!-- End Header -->
