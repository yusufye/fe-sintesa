    ...
    <div class="container" data-aos="fade-up">
      <div class="row">
        <div class="col-sm-3">
          ...
          <input class="form-control form-control-sm Globalfilters" data-filtername="nama_kegiatan" type="text" placeholder="Nama kegiatan">
        </div>  
        <div class="col-sm-3">
          <label>Narasumber</label>
          <input class="form-control form-control-sm Globalfilters" data-filtername="nama" type="text" placeholder="Narasumber">
        </div>  
        <div class="col-sm-3">
          <label>Tanggal Kegiatan</label>
          <input class="form-control form-control-sm Globalfilters" data-filtername="tgl_kegiatan" data-filtertype="date_range_start" type="date" placeholder="Tanggal Kegiatan">
        </div>
        <div class="col-sm-3">
        <label></label>
          <input class="form-control form-control-sm Globalfilters" data-filtername="tgl_kegiatan" data-filtertype="date_range_end" type="date" placeholder="Tanggal Kegiatan">
        </div>  
      </div>
      <br>

      <table id="tableDetailKegiatan" class="table">
          <thead>
              <tr>
