<section id="services" class="services">
    <div class="container" data-aos="fade-up">
      <div class="row">
        <div class="col-sm-3">
          <input class="form-control form-control-sm Globalfilters" data-filtername="nama" type="text" placeholder="Nama Narasumber">
        </div>  
        <div class="col-sm-3">
          <input class="form-control form-control-sm Globalfilters" data-filtername="tgl_update" type="date" placeholder="Tanggal Update">
        </div>  
      </div>
      <br>
    ...
    <select name="filter_kode" id="filter_kode" data-filtername="kode" class="filters">
        ...
        <table id="tableDetailPendidikan" class="table tablex">
            <thead>
                <tr>
